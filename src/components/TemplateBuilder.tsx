...
import TemplateLanguage from './sections/TemplateLanguageSection';
    ...
    <div className="rsp-min-h-screen rsp-bg-white">
      <div className="rsp-max-w-[1200px] rsp-mx-auto rsp-px-6 rsp-h-full">
        ...
        <div className="rsp-py-6 rsp-border-b rsp-border-gray-200">
          <button
            onClick={() => navigate('/')}
            className="rsp-flex rsp-items-center rsp-gap-2 rsp-text-gray-500 hover:rsp-text-gray-700 rsp-text-sm rsp-mb-4"
          >
            <ChevronLeft className="rsp-w-5 rsp-h-5" />
            <span>Back to Templates</span>
          </button>
          <div className="rsp-flex rsp-items-center rsp-justify-between">
            <h1 className="rsp-text-2xl rsp-font-semibold rsp-text-gray-900">Add Template</h1>
            <button
